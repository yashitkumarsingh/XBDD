...
import xbdd.model.databind.CoordinatesConverter;
...
@JsonSerialize(converter = CoordinatesConverter.class)
public class Coordinates {
	...
	public Coordinates(final String product) {
	...
	public BasicDBObject getReportCoordinates() {
		return new BasicDBObject().append("product", this.product).append("major", this.major).append("minor", this.minor)
				...
				.append("build", this.build).append("version", getVersion());
	}
	...
	public String getTestingTipsId(final String featureId, final String scenarioId) {
		return this.product + "/" + getVersion() + "/" + getBuild() + "/" + featureId + "/" + scenarioId;
	}
	...
	public BasicDBObject getSummaryReportQueryObject() {
		return new BasicDBObject("_id", this.product + "/" + getVersion()).append("product", this.product)
	...
	public String getFeature_Id(final String id) {
		return this.product + "/" + getVersion() + "/" + getBuild() + "/" + id;
	}
		...
		for (final Field f : fields) {
			switch (f) {
				...
				case VERSION_AS_STRING:
					o.append("coordinates.version", getVersion());
					break;
				case BUILD:
