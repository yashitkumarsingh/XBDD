...
//		feature.setObjectId("p1/f1");
//		feature.setId("f1");
//		feature.setDescription("");
//		feature.setName("f1");
//		Coordinates coordinates = new Coordinates((BasicDBObject) JSON.parse("{'product' : 'P1','major' : 1,'minor' : 1,'servicePack' : 1,'build' : 'build1','version' : '1.1.1'}"));
//		feature.setCoordinates(coordinates);
//		feature.setCalculatedStatus(Statuses.UNKNOWN.getTextName());
//		feature.setOriginalAutomatedStatus(Statuses.UNKNOWN.getTextName());
