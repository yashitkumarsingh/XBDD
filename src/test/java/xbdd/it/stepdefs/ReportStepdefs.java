...
import xbdd.it.report.ReportContext;
import xbdd.it.report.ReportManager;
import xbdd.it.report.ScenarioSummary;
import xbdd.it.report.StepSummary;
import xbdd.it.utils.XBDDInstance;
...
public class ReportStepdefs {
	...
	private final static String BASIC_REPORT_JSON_FILE = "xbdd/it/basic-report.json";
	...
	public void a_cucumber_json_test_report_for_the_feature_containing_scenarios(final List<String> scenarios) {
		final String report = "xbdd/it/mixed-" + StringUtils.join(scenarios.toArray(), "-") + "-report.json";
		this.reports.add(report);
	}

	@Given("^a scenario with undefined status$")
	public void a_scenario_with_undefined_status() {
		this.reports.add("xbdd/it/mixed-scenario1-scenario3-report.json");
	}
	...
	public void a_cucumber_json_test_report_for_the_scenario_with_status_passed() {
		this.reports.add("xbdd/it/mixed-scenario1-scenario2-report.json");
	}

	@Given("^a test result has been uploaded with an embedded attachment$")
	public void a_test_result_has_been_uploaded_with_an_embedded_attachment() throws Throwable {
		a_test_result_has_been_uploaded();
	}
	...
	@When("^the user views the test report for the scenario with an attachment$")
	public void the_user_views_the_test_report_for_the_scenario_with_an_attachment() {
		this.scenarioSummary = this.reportManager.openScenario(this.reportContext, "scenarios-can-have-attachments",
				"a-scenario-with-an-attachment");
	...
	public void the_attachment_is_displayed() {
		this.reportManager.getAttachment();
	}
}
